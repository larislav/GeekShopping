...
namespace GeekShopping.CartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartDTO> SaveOrUpdateCart(CartDTO cartDTO)
        {
            ...
            var product = await _context.Products.FirstOrDefaultAsync(p => p.Id == cartDTO.CartDetails.FirstOrDefault().ProductId);
            ...
            {
                var cartDetail = await _context.CartDetails.AsNoTracking().FirstOrDefaultAsync(c => c.ProductId == cartDTO.CartDetails.FirstOrDefault().ProductId
